...
if __name__ == "__main__":
    ...
    evaluate_mf_sindy(
        ...
        gen_hf_kwargs={"noise_level": 0.01*std_test},   # high-fidelity noise
        gen_lf_kwargs={"noise_level": 0.25*std_test},   # low-fidelity noise
        gen_test_kwargs={"noise_level": 0.0, "T": 1.0, "n_traj":1, "seed":999},
        lib_kwargs={
            "derivative_order": 2,
            "p": 2,
        },
